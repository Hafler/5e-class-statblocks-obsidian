...
cr: '14'
stats: [8, 20, 14, 10, 16]
aliases: ["Ranger (Tier IV)"]
---

# Ranger (Tier IV)
```ad-statblock
title: Ranger (Tier IV)
 ...
 ***Longbow, +2.*** Ranged Weapon Attack: +8 to hit, reach 600 ft., one target. Hit: 23 (1d8+17) piercing damage.
 ## Bonus Actions
 ***Swift Quiver, 5th level spell, concentration (2/day).*** For the next minute, the Ranger can make two Longbow attacks as a bonus action.

 ***Vanish.*** The Ranger can Hide as a bonus action.

 ## Reactions
 ***Shadowy Dodge.*** Whenever a creature makes an attack roll against the Ranger and doesn't have advantage on the roll, it can use its reaction to impose disadvantage on it.```
^statblock
